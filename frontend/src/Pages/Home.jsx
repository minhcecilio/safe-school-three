...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      route: '/profile' // In mock app, user profile handles appointment logs
    },
    {
      id: 'chat',
      icon: (
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Safe School đồng hành cùng học sinh, phụ huynh và nhà trường trong việc phòng chống bạo lực học đường, cung cấp kiến thức bảo vệ bản thân và kênh kết nối nhanh chóng với các chuyên gia tâm lý học.
            </p>
          ...
          <div className="cta-banner-card">
            <div className="cta-banner-content">
              ...
              <p className="cta-desc">
                Đừng im lặng. Hãy chia sẻ với Safe School hoặc kết nối trực tiếp với Tổng đài Quốc gia Bảo vệ Trẻ em để nhận được sự trợ giúp bảo mật, kịp thời nhất.
              </p>
            </div>
